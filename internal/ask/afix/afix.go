...
func init() {
	path = os.Getenv("GOPATH") + "/src/github.com/coralproject/xenia/internal/ask/afix/"
}
...
func TearTestDatabase(db *db.DB) {
	...
	collections := []string{form.Forms, form.FormSubmissions, form.FormGalleries}
...
func GetFixtureFormSubmission() (*form.Submission, error) {
...
func GetFixtureFormSubmissionInput() (*form.SubmissionInput, error) {
	...
	var submission *form.SubmissionInput
	err = json.NewDecoder(file).Decode(&submission)
